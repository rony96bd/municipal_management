...
@section('dash-body')
    <div class="flex column full-width gap-20">
        <a href="{{ route('create-gallery') }}"
            ...
            নতুন গ্যালারি যুক্ত করুন
        </a>

        <div class="flex full-width justify-content-end flex column gap-10 mart-20 bradius-3px">
            <h2 class="fs-h2">সকল গ্যালারি</h2>
            <div class="flex column gap-0 border-solid border-1px border-color-primary bradius-3px overflow-hidden">
                ...
                <div id="gallery-list" class="sortable-list flex column gap-0">
