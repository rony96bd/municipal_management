    ...
    <div class="flex column full-width gap-20">
        ...
        <div class="flex full-width justify-content-end flex column gap-10 mart-20 bradius-3px overflow-hidden">
            ...
            <div class="flex column gap-0 border-solid border-1px border-color-primary bradius-3px overflow-hidden">
                ...
                <div id="officials-list" class="sortable-list">
                    @forelse ($officials as $page)
                        <div class="page-repeater grid grid-col-3 border-color-primary full-width gap-10 m-grid-col-1 m-gap-0"
                            data-id="{{ $page->id }}">
                            <div class="flex row">
                                <!-- The entire page-repeater box will now be draggable -->
                            ...
                            <div class="flex row jfe-ace gap-10 padt-10 padb-10 padl-20 padr-20 m-column m-jst-ast">
                                <div class="anchor copy-url flex center padl-20 padr-20 padt-10 padb-10 m-display-none"
                                    data_link="{{ url('/officer') }}/{{ $page->page_url }}"
                                    title="পাতার ইউ আর এল কপি করুন">
                    ...
                    @empty
                        <div class="flex row center padar-10 text-center color-danger font-weight-bold">কোন তথ্য পাওয়া
                            যায়নি।
                        </div>
                    @endforelse
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const sortable = new Sortable(document.getElementById('officials-list'), {
