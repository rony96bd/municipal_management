                    ...
                    <div class="mob-sub-wrapper display-none">
                        <ul class="mob-sub-menu padar-10 gap-10 flex column full-width">
                            ...
                            @if (!$top_menu->submenus->isEmpty() && $top_menu->groupmenus->isEmpty())
                                ...
                                <ul class="sub-menu position-absolute left-0 top-0 padt-50 transition-ease-in-out transition-duration-0-25s transition-property-all z-index-1 padl-20 padr-20 padb-20 gap-10 flex column">
