            ...
            <div class="flex column gap-0 border-solid border-1px border-color-primary bradius-5px overflow-hidden">
                ...
                @if (!empty($stuff->home_phone))
                    <div class="flex grid grid-col-2 padar-10 single-detail-wrapper jce-aic">
                        ...
                        <p class="text-left">{{ englishToBanglaNumber($stuff->home_phone) }}</p>
                    </div>
                @endif
                @if (!empty($stuff->mobile))
                    <div class="flex grid grid-col-2 padar-10 single-detail-wrapper jce-aic">
                        ...
                        <p class="text-left">{{ englishToBanglaNumber($stuff->mobile) }}</p>
                    </div>
                @endif
                @if (!empty($stuff->fax))
                    <div class="flex grid grid-col-2 padar-10 single-detail-wrapper jce-aic">
                ...
                @if (!empty($stuff->joining_date))
                    <div class="flex grid grid-col-2 padar-10 single-detail-wrapper jce-aic">
                        ...
                        <p class="text-left">{{ englishToBanglaNumber(\Carbon\Carbon::parse($stuff->joining_date)->format('d-m-Y')) }}</p>
                    </div>
                @endif
