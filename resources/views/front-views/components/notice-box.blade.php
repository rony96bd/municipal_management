<div class="noticebox border-gray background-gray padar-30 bradius-6px gap-30 flex column"
    ...
    <div class="flex column">
        ...
        @endforelse
        {{-- Primary Button --}}
        <a href="{{route('notices')}}" class="anchor flex center primary-button background-primary color-white padl-20 padr-20 padt-10 padb-10 bradius-3px mart-20 marl-auto">সকল নোটিশ</a>
    </div>
</div>
